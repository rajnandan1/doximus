...
type CurlJSON struct {
	...
	Configurables []APIConfigurables `json:"configurables" yaml:"configurables,omitempty"`
	Curls         []CurlAPIJSON      `json:"apis" yaml:"apis,omitempty"`
}
...
type CurlAPIJSON struct {
	...
	Logo        string        `json:"logo" yaml:"logo"`
	Description string        `json:"description" yaml:"description"`
	Examples    []CurlExample `json:"examples" yaml:"examples,omitempty"`
}
